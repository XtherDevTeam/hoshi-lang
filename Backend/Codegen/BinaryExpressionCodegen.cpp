...
namespace Hoshi {
    ...
    Operand BinaryExpressionCodegen::Visit(BinaryExpressionNode &Node, IRProgram::Builder &Program) {
        ...
        Operand LastResult = LogicEqualExpressionCodegen::INSTANCE.Visit(*Node.GetOperands(0),
        ...
        for (int i = 0; i < Node.GetOperators().size(); i++) {
            ...
            Operand ThisOperand = LogicEqualExpressionCodegen::INSTANCE.Visit(*Node.GetOperands(i + 1),
